...
st.header(
    "Unveiling Parkinson's with Precision - 83% Accurate Detection Algorithm Trained on Spiral and Wave Sketches."
)
...
with st.sidebar:
    ...
    st.header("Diseased Person")
    img = Image.open("./Images/diseased_person.png")
    st.image(img)
...
with col1:
    ...
    st.subheader("Drawable Canvas Spiral")
...
with col1:
    # Create a canvas component
    st.subheader("Drawable Canvas Wave")
    canvas_image = st_canvas(
        fill_color="rgba(255, 165, 0, 0.3)",
        stroke_width=stroke_width,
        stroke_color=stroke_color,
...
with col2:
    ...
    st.markdown("""
        <div data-stale="false" width="344" class="element-container css-90qg9c e1f1d6gn2"><div class="stMarkdown" style="width: 344px;"><div data-testid="stMarkdownContainer" class="css-b9uxpg e1nzilvr4" style="width: 344px;"><div class="css-k7vsyb e1nzilvr1"><h3 id="preview2"><div class="css-zt5igj e1nzilvr3"><a href="#preview2" class="css-1cfor5t e1nzilvr2"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><br><br><span class="css-10trblm e1nzilvr0">Preview2</span></div></h3></div></div></div></div>""", unsafe_allow_html=True)
    ...
    if canvas_image.image_data is not None:
        ...
        #to generate a unique filename for the user's input image.
def generate_user_input_filename():
    unique_id = uuid.uuid4().hex
    filename = f"user_input_{unique_id}.png"
    return filename

#to make predictions using a pre-trained machine learning model and return the result.
...
<div style="text-align: center; font-size: medium; margin-top:50px;">
    Your Parkinson's Doesn't Define You,
